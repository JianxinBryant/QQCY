...
<header class="top">
    ...
    <div class="containner1" >
        <div class="box1">
            ...
            <a href="#" style="position: absolute;bottom: 25px;right: 15px;color: #5cb85c">查看详情</a>
        </div>
        <div class="box2">
            <div class="text2">
                <h1>苦瓜</h1>
            ...
            <a href="#" style="position: absolute;bottom: 25px;left: 60px;color: #b2dba1">查看详情</a>
            <a href="${basePath }res/img/p2.png"><img src="${basePath }res/img/p2.png"></a>
        </div>
        <div class="box3">
            <img src="${basePath }res/img/p3.png">
            <btn class="btn"><a href="#"><strong>查看详情</strong></a></btn>
        </div>
    </div>
    <div class="footer">
        <div class="footbox">
