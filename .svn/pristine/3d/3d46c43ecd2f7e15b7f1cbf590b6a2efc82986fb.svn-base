...
<body>
    ...
    <div class="infomation">
        ...
        <input class="col-sm-4" type="text" placeholder="请输入商品简介" name="v_title" value="${vegetable.v_title }">
        ...
        <input type="text" placeholder="请输入详细描述" name="v_discribe" value="${vegetable.v_discribe }" >
    ...
    <div class="spxq">
        ...
        <input class="btn btn-primary" type="submit" value="提交" style="float: right; margin-bottom: 15px">
    </div>
